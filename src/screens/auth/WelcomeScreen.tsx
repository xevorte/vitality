import { View, TouchableOpacity, SafeAreaView, ScrollView, Image, KeyboardAvoidingView, Platform } from 'react-native';
    ...
    <SafeAreaView className="flex-1 bg-[#FAF8FF]">
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
        <ScrollView className='min-h-screen' showsVerticalScrollIndicator={false}>
          <View className="flex items-center justify-center bg-white h-24 p-4 pt-12 pb-0">
            <Image source={Logo} className="w-36 h-16 mb-6" resizeMode='contain' />
          </View>

          <View className='flex-1 p-4'>
            <View  
              className="w-full h-[40vh] mb-6 overflow-hidden"
            >
          ...
          <View className="flex-col gap-2 items-center bg-white py-4 shadow-xl shadow-gray-200">
