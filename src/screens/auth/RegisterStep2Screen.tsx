        ...
        >
          ...
          <View className="mb-6">
            ...
            <View className="w-full bg-[#F2F3FF] rounded-xl px-4 py-4">
              <TextInput
                ...
                className="w-full text-base text-[#18042A] p-0"
          ...
          <View className="mb-8">
            ...
            <View className="flex-row justify-between w-full gap-x-4">
              <TouchableOpacity className={`flex-1 bg-white border ${registerData?.gender === 'male' ? 'border-[#006C49]' : 'border-[#E2E8F0]'} rounded-2xl py-8 items-center shadow-sm`} onPress={() => setRegisterData({ ...registerData, gender: 'male' })}>
              ...
              {/* Card Wanita */}
              <TouchableOpacity className={`flex-1 bg-white border ${registerData?.gender === 'female' ? 'border-[#006C49]' : 'border-[#E2E8F0]'} rounded-2xl py-8 items-center shadow-sm`} onPress={() => setRegisterData({ ...registerData, gender: 'female' })}>
                <View className="w-16 h-16 bg-[#F2F3FF] rounded-full items-center justify-center mb-4">
                  <Text size={24} type="bold" className="!text-[#006C49]">
                    ♀
                  </Text>
          ...
          <View className="flex-row justify-between items-center mt-auto pt-8">
            ...
            <TouchableOpacity className="bg-primary disabled:bg-[#E2E7FF] px-6 py-3.5 rounded-full flex-row items-center shadow-sm" disabled={!registerData?.name || !registerData?.gender} onPress={() => NavigationServices.push(NAVIGATION_NAME.AUTH.registerStep3Screen, {})}>
